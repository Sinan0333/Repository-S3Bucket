    ...
    <div className="card2">
      <form className="form" onSubmit={signUP}>
        ...
        <div className="field">
          ...
          <input type="text" className="input-field" placeholder="Username" autoComplete="off" value={name} onChange={(e)=>setName(e.target.value)} />
        </div>
        <div className="field">
          <svg
            viewBox="0 0 16 16"
          ...
          <input type="text" className="input-field" placeholder="Email" autoComplete="off"  value={email} onChange={(e)=>setEamil(e.target.value)} />
        </div>
        <div className="field">
          <svg
            viewBox="0 0 16 16"
